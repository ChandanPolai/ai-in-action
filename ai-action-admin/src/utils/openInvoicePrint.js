...
/** Open invoice in a new tab for viewing (does not auto-print). */
...
/** Trigger browser print dialog (only when user asks). */
...
/** @deprecated use openInvoicePreviewTab or printInvoice */
